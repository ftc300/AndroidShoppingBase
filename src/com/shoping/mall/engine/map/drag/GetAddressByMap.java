package com.shoping.mall.engine.map.drag;
...
import com.shoping.mall.bean.ConsigneeAddress;
import com.shoping.mall.engine.map.MapResultData;
import com.shoping.mall.engine.map.ShowMapData;
import com.shoping.mall.engine.map.UpdateMapResultListener;
import com.shoping.mall.util.LogUtil;

/**
 * 演示覆盖物的用法
 */
public class GetAddressByMap extends BaseActivity implements
	...
	private void initMap() {
		...
		mBaiduMap.setOnMapStatusChangeListener(new OnMapStatusChangeListener() {
			...
			public void onMapStatusChangeStart(MapStatus arg0) {
				...
				LogUtil.i("shen", "onMapStatusChangeStart"
			...
			public void onMapStatusChangeFinish(MapStatus arg0) {
				// TODO Auto-generated method stub
				LogUtil.i("shen", "onMapStatusChangeFinish"
						+ arg0.target.latitude + ":" + arg0.target.longitude);
	...
	public class SDKReceiver extends BroadcastReceiver {
		public void onReceive(Context context, Intent intent) {
			...
			if (s.equals(SDKInitializer.SDK_BROADTCAST_ACTION_STRING_PERMISSION_CHECK_ERROR)) {
				Toast.makeText(GetAddressByMap.this, "key 验证出错! ",
						Toast.LENGTH_SHORT).show();
				LogUtil.d( TAG + "key 验证出错! ");
			} else if (s
					.equals(SDKInitializer.SDK_BROADCAST_ACTION_STRING_NETWORK_ERROR)) {
				LogUtil.d( TAG + "网络出错");
				Toast.makeText(GetAddressByMap.this, "网络出错", Toast.LENGTH_SHORT)
						.show();
			}
		}
	}
	...
	private static class DragSearchHandler extends Handler {
		...
		WeakReference<GetAddressByMap> mActivityReference;

		DragSearchHandler(GetAddressByMap acitivity) {
			mActivityReference = new WeakReference<GetAddressByMap>(acitivity);
		}

		@Override
		public void handleMessage(Message msg) {
			final GetAddressByMap activity = mActivityReference.get();
	...
	public void updateReverseGeoCodeResult(ReverseGeoCodeResult result) {
		if (null != result) {
			...
			LogUtil.i("地址为：" + result.getAddress());
