...
public class RoundedImageViewWithBorder extends ImageView {
    ...
    public RoundedImageViewWithBorder(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_image_border_width, -1);
        ...
        mBorderColor = a.getColorStateList(R.styleable.RoundedImageView_image_border_color);
