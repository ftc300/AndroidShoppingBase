package com.shoping.mall.study.welanim.activity.fragment.outlayer.welcomelayer;
...
public class LoginAnimImageSecondFragment extends LoginAnimImageBaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.welcome_fragment_welcomanim_image_second, null);
