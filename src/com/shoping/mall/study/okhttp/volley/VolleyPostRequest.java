...
import com.shoping.mall.study.okhttp.lib.request.CountingRequestBody;
 ...
 */
public class VolleyPostRequest extends VolleyRequest
{
    ...
    protected VolleyPostRequest(String url, Object tag, Map<String, String> params, Map<String, String> headers, MediaType mediaType, String content, byte[] bytes, File file)
    {
