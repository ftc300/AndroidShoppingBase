...
import com.shoping.mall.study.htextview.util.CharacterUtils;
import com.shoping.mall.study.htextview.util.HLog;
/**
 * 缩放动画
...
public class PixelateText implements IHText {
    ...
    private List<CharacterDiffResult> differentList = new ArrayList<CharacterDiffResult>();
