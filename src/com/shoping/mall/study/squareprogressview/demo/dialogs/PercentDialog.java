package com.shoping.mall.study.squareprogressview.demo.dialogs;
...
import com.shoping.mall.study.squareprogressview.demo.PreviewView;
...
public class PercentDialog extends Dialog {
	...
	public PercentDialog(final Context context) {
		...
		this.setContentView(R.layout.square_percentdialog);
