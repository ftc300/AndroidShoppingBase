...
public class FileUtil {
	...
	public static Map<String,String> mProperty = new HashMap<String,String>();
	...
	public static boolean getProperties(Context context) {
		Properties prop = new Properties();
		try {
			// 读取属性文件a.properties
			InputStream in = context.getResources().openRawResource(R.raw.ebdpabt_setting);   
			...
			while (it.hasNext()) {
				...
				//LogUtils.i(Constants.SHEN_TAG, TAG + key + ":" + prop.getProperty(key));
			}
			in.close();
			return true;
		} catch (Exception e) {
			//LogUtils.i(Constants.SHEN_TAG, TAG + "读取配置文件出错了！" + e.toString() );
			return false;
		}
	}
